...
function(generated_source)
    ...
    set(GENSRC_CMAKE "${GENSRC_OUTDIR}/gensrc.cmake")
    ...
    set(GENSRC_CMAKE_COPY "${GENSRC_OUTDIR}/gensrc.cmake.copy")
    ...
    set(GENSRC_ARGS "${GENSRC_OUTDIR}/gensrc.args")
    set(GENSRC_OUTDATED OFF)

    if(NOT EXISTS "${GENSRC_ARGS}" OR NOT EXISTS "${GENSRC_CMAKE_COPY}")
        message(STATUS "${GENSRC_FUNC_NAME}: gensrc.cmake.copy does not exist")
